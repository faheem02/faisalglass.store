...
define('DB_USER', 'atrmarke_faysal_glass');  // Update with your DB username
define('DB_PASS', 'ATRsales123');   // Update with your DB password
define('DB_NAME', 'atrmarke_faysal_glass');
