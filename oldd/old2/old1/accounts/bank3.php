...
// Bank details
$bank_name = "Bank 3 - MCB Bank Limited";
$bank_account = "MCB-4567-8901234";
...
// Get opening balance
$opening_query = "SELECT balance FROM bank3_transactions 
...
// Get transactions
$trans_query = "SELECT * FROM bank3_transactions 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form method="GET" action="" class="form-inline justify-content-between flex-wrap">
                                ...
                                <div>
                                    ...
                                    <a href="bank3.php" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold" style="color: #1e7e34;">
                                <i class="fas fa-list"></i> Bank 3 Transaction Ledger
                            </h6>
                        </div>
                        <div class="card-body">
