...
// Bank details
$bank_name = "Bank 1 - Habib Bank Limited (HBL)";
$bank_account = "HBL-1234-5678901";
...
$opening_query = "SELECT balance FROM bank1_transactions 
...
$trans_query = "SELECT * FROM bank1_transactions 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form method="GET" action="" class="form-inline justify-content-between flex-wrap">
                                ...
                                <div>
                                    ...
                                    <a href="bank1.php" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold" style="color: #1e7e34;">
                                <i class="fas fa-list"></i> Bank 1 Transaction Ledger
                                ...
                                <table class="table table-bordered table-hover" id="bankTable" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($transactions as $trans): 
                                            ...
                                            if($trans['reference_type'] == 'SALE') {
                                            ...
                                            } elseif($trans['reference_type'] == 'CUSTOMER_PAYMENT') {
                                                $ref_display = '<span class="badge badge-success">PAY-' . str_pad($trans['reference_id'], 5, '0', STR_PAD_LEFT) . '</span>';
                                            } elseif($trans['reference_type'] == 'PURCHASE') {
                                                $ref_display = '<span class="badge badge-warning">PUR-' . str_pad($trans['reference_id'], 5, '0', STR_PAD_LEFT) . '</span>';
                                                ...
                                                $ref_display = '<span class="badge badge-info">TRF-IN-' . str_pad($trans['reference_id'], 5, '0', STR_PAD_LEFT) . '</span>';
                                            } elseif($trans['reference_type'] == 'TRANSFER_OUT') {
                                                $ref_display = '<span class="badge badge-secondary">TRF-OUT-' . str_pad($trans['reference_id'], 5, '0', STR_PAD_LEFT) . '</span>';
                                            } else {
