<?php
/**
 * Print Sale Invoice Page - WITH FIXED TOTAL AREA CALCULATION & REMARKS DISPLAY
...
<div class="invoice-container" id="invoiceContent">
    ...
    <div class="company-header">
        <div class="company-name" style="font-weight: bold;">Faisal Glass & Aluminum Center</div>
    ...
    <!-- Client Information Grid - Added Remarks -->
    <div class="info-grid">
        ...
        <div class="info-value"><?php echo !empty($sale['remarks']) ? htmlspecialchars($sale['remarks']) : '-'; ?></div>
        ...
        <!-- empty cells to keep grid balanced -->
        <div></div><div></div>
    </div>
        ...
        <tbody>
            ...
            foreach($products_list as $detail):
                if($detail['product_id'] > 0):
                    ...
                    // ---------- FIX: Calculate Total Area from dimensions ----------
                    // Area per piece (sq ft) = (height * width) / 144 (since dimensions are in inches)
                    $area_per_piece = ($client_h * $client_w) / 144;
                    $total_area = $area_per_piece * $qty;
                    // -----------------------------------------------------------------
