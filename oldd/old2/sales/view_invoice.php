...
<tr>
    ...
    <td>
        ...
        <!-- NEW Edit button -->
        <button class="btn btn-sm btn-primary ml-1" onclick="window.location.href='edit_sale.php?id=<?php echo $sale['id']; ?>'">
