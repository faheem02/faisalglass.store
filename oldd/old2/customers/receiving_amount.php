        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4 no-print">
                        <h1 class="h3 mb-0" style="color: #1e7e34;">
                            <i class="fas fa-hand-holding-usd"></i> Receive Payment from Customer
                        </h1>
                    ...
                    <?php if($success): ?>
                        ...
                        <div class="receipt-preview text-center">
                            ...
                            <h5>Payment Receipt #RCP-<?php echo str_pad($receipt_id ?? 0, 5, '0', STR_PAD_LEFT); ?></h5>
                            <p>Amount: <strong>₨ <?php echo number_format($amount, 2); ?></strong> received from <strong><?php echo htmlspecialchars($customer['customer_name'] ?? ''); ?></strong></p>
                            <a href="view_customer.php" class="btn btn-success btn-sm">
                                <i class="fas fa-check"></i> Done
                            </a>
                            <a href="receiving_amount.php?id=<?php echo $customer_id; ?>" class="btn btn-primary btn-sm">
                                <i class="fas fa-plus"></i> Another Payment
                            </a>
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="col-md-8">
                            <div class="card form-card">
                                <div class="card-header-custom">
                                    <i class="fas fa-money-bill-wave"></i> Payment Receipt Form
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="" id="receiptForm">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    ...
                                                    <div class="balance-amount">
                                                        ...
                                                        echo ($bal >= 0) ? ' DR (Receivable - Customer owes you)' : ' CR (Payable - You owe customer)';
                                                        ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group" id="bank_account_div" style="display: none;">
                                            <label class="required-field">Select Bank Account</label>
                                            <select name="bank_account_id" class="form-control">
                                                ...
                                                ?>
                                                    <option value="<?php echo $bank['id']; ?>">
                                                        ...
                                                        <?php echo htmlspecialchars($bank['account_title'] ?? $bank['account_number']); ?>
                                                    </option>
                                                <?php endwhile; ?>
                                            </select>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow mb-4">
                                <div class="card-header" style="background: #4e73df; color: white;">
                                    <h6 class="m-0 font-weight-bold"><i class="fas fa-info-circle"></i> Payment Instructions</h6>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header" style="background: #1e7e34; color: white;">
                                    <h6 class="m-0 font-weight-bold"><i class="fas fa-history"></i> Recent Payments</h6>
                                </div>
                                        ...
                                        <div class="list-group-item">
                                            <div class="d-flex w-100 justify-content-between">
                                                <small class="text-muted">
                                                    <i class="fas fa-calendar-alt"></i> <?php echo date('d-m-Y', strtotime($rec['receipt_date'])); ?>
                                                </small>
                                                <small class="text-success font-weight-bold">₨ <?php echo number_format($rec['amount'], 2); ?></small>
                                            </div>
                                            <div class="mt-1">
                                                <strong><?php echo htmlspecialchars($rec['customer_name']); ?></strong>
                                                <br>
                                                <small class="text-muted">
                                                    <i class="fas fa-<?php echo $rec['payment_method'] == 'cash' ? 'money-bill' : 'university'; ?>"></i>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#payment_method').change(function() {
                if($(this).val() == 'bank') {
                    $('#bank_account_div').slideDown();
                    $('select[name="bank_account_id"]').prop('required', true);
                } else {
                    $('#bank_account_div').slideUp();
            ...
            $('#customer_id').change(function() {
                ...
                if(customerId) {
                    ...
                    var balanceAbs = Math.abs(balanceNum).toFixed(2);
                    var balanceText = '₨ ' + balanceAbs;
                    
                    if(balanceNum > 0) {
                        balanceText += ' DR (Receivable - Customer owes you)';
                        $('#displayBalance').css('color', '#28a745');
                    } else if(balanceNum < 0) {
                        balanceText += ' CR (Payable - You owe customer)';
                        $('#displayBalance').css('color', '#dc3545');
                    } else {
                        balanceText += ' (Settled - No balance)';
                        $('#displayBalance').css('color', '#6c757d');
                    }
            ...
            // Show preview when amount is entered
            ...
            $('#receiptForm').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    html: `Are you sure you want to receive <strong>₨ ${amount.toFixed(2)}</strong> from <strong>${customerName}</strong>?`,
                    icon: 'question',
