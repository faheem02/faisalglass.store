<?php
/**
 * Print Expense Detail Receipt Page
...
$created_by = isset($_SESSION['username']) ? $_SESSION['username'] : 'User';
?>
...
<div class="list-container" id="listContent">
    ...
    <div class="voucher-head">
        <div class="voucher-title"><i class="fas fa-file-invoice-dollar"></i> Expense Voucher</div>
        <div class="voucher-no">
            Voucher No: <span class="big">EXP-<?php echo str_pad($expense['id'], 4, '0', STR_PAD_LEFT); ?></span>
        </div>
    </div>
    ...
    <div class="info-grid">
        ...
        <div class="info-item">
            ...
            <span class="info-value"><?php echo htmlspecialchars($expense['head_name']); ?></span>
        </div>
        <div class="info-item">
        ...
        <div class="info-item">
            ...
            <span class="info-value"><?php echo htmlspecialchars($expense['reference_no']) ?: '-'; ?></span>
        </div>
    </div>

    <div class="amount-box">
        <div class="amount-label">Expense Amount</div>
        <div class="amount-value"><?php echo formatCurrency($expense['amount']); ?></div>
    </div>
    ...
    <table class="detail-table">
        ...
        <?php if($expense['payment_method'] == 'bank' && !empty($expense['bank_name'])): ?>
        <tr>
            <th>Bank Details</th>
            <td>
                <?php echo htmlspecialchars($expense['bank_name']); ?>
                <?php if(!empty($expense['account_title'])): ?><br><?php echo htmlspecialchars($expense['account_title']); ?><?php endif; ?>
                <?php if(!empty($expense['account_number'])): ?> (<?php echo htmlspecialchars($expense['account_number']); ?>)<?php endif; ?>
            </td>
        </tr>
        <?php endif; ?>
    ...
    <div class="list-footer">
        <div class="generated-info">
            ...
            Created By: <?php echo htmlspecialchars($created_by); ?>
        </div>
