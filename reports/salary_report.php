            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-3">
                        ...
                        <div class="no-print">
                            <button onclick="window.open('print_salary_report.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&filter_type=<?php echo $filter_type; ?>&employee_id=<?php echo $employee_filter; ?>', '_blank', 'width=1000,height=750')" class="btn btn-secondary btn-sm">
